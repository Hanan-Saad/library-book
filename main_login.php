...
<form  name="form1" method="post" action="checklogin.php">
                	 ...
                	 <input name='myusername' type='text' class="form-control" id='fullname' placeholder='User Name' maxlength='40'><br> <br>
              </div>
			
            <div class="templatemo_form" >  	
	       <input name='mypassword'   type='password' class="form-control"  id='message' placeholder='passwerd' maxlength='40'><br> <br>
              </div>
			
		     <input name='Submit'  value ='Log in' type='submit'  id='submit' placeholder='Log in' class="btn btn-primary"> 
